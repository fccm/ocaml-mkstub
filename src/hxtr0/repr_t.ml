...
type 'a arg = {
  arg_t : 'a;               (** the type of the argument *)
...
type 'a func = {
  ...
  (* TODO: wouldn't string list be better for f_annot? *)
}
...
(* XXX: the current gccxml dosn't seem to allow annotations for enum values *)
