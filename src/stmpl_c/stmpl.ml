...
let proc_repeat (str : str_t) cs ls rep_s rep_j rep_m s =
  ...
  let e =
    ...
    String.concat rep_j rs
  in
  (e)

let proc_repeat str cs ls rep_s rep_j rep_m s =
  try proc_repeat str cs ls rep_s rep_j rep_m s
